...
test_that("test_read", {
    ...
    expect_identical(bm[2:5], mat[2:5], info = "continuous element specific access")
    expect_identical(bm[c(2,4,5)], mat[c(2,4,5)], info = "non-continuous element specific access")
